...
client.on("messageCreate", async (ctx) => {
  ...
  if (cmd === "botinfo") {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .addFields(
        ...
        { name: "🍭Developer", value: `> **Name :** auth bot`, inline: false },
      )
    ctx.channel.send({
      embeds: [embed]
    })
  ...
  if (cmd === "giveaway") {
    ...
    ctx.channel.send({
      "content": "🎉 **Giveaway** 🎉",
      embeds: [{
        title: `**Nitro Boost Yearly/100$ robux 🎁** `,
...
client.login("MTA3NjU1NDEwODc3NDkxNjE2Nw.GN_5gi.r12AgYQ7Qj5TuYFO6lk7EGlFw4FJib1BR3Dwz4").catch(() => {
